		...
		<div class="scroll-view-wrapper" :class="{'visibility':!pageView}">
			<div class="address_title_wrapper">
				<div class="address_title">
					<h5>选择地址</h5>
					<span @click="invoiceAptitudeDelete" v-show="isDelete">删除</span>
				</div>
			</div>
			<div class="billing_address_item" v-for="(item,index) in list">
				...
				<div class="billing_address_edit" @click="pageAction('/invoice/address/edit?id='+item.id)">
			...
			<div class="select_address_add" @click="pageAction('/invoice/address/add')">
...
<script>
	...
	export default {
		...
		methods: {
			...
			getInvoiceAptitudeList () {

				API.getInvoiceAptitudeList({
					type: "GET"
				}).then((res) => {
